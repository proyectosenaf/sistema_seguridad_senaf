// src/modules/rondasqr/supervisor/DetailedMarks.jsx
...
function Th({ children, className = "" }) {
  return (
    <th className={`text-left px-3 py-2 whitespace-nowrap ${className}`}>
      {children}
    </th>
  );
}
...
function durationText(rows) {
  ...
  const ss = secs % 60;
  return `Duración ${dd} días - ${String(hh).padStart(
    2,
    "0"
